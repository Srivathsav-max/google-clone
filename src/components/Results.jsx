...
import { useLocation } from 'react-router-dom'//useLocation is a hook that returns the current location object
...
export const Results = () => {
  ...
  const location = useLocation() // to get the search query from the url
  useEffect(() => {
    if(searchTerm){
